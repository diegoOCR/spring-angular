...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter implements  WebSocketMessageBrokerConfigurer {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/clientes", "/api/clientes/page/**", "/api/uploads/img/**", "/images/**", "/chat-websocket/**").permitAll()
		.antMatchers("/api/usuarios", "/api/usuariorole", "/api/usuariorole", "/chat-websocket/**", "/api/contacto", "/api/email").permitAll()
//		.antMatchers("/api/usuariorole").permitAll()
//		.antMatchers("/api/usuariorole").permitAll()
